...
```
[v1.8.0] 알림 기능 개선 및 앱 안정성 향상
- Android 앱에서 알림이 정상적으로 전달됩니다 (앱이 꺼진 상태에서도)
- 감사 기록을 이미지로 SNS에 공유할 수 있습니다
- 뒤로가기 버튼으로 창을 닫을 수 있습니다
- 앱 안정성 개선 및 UI 개선
```
...
| 4 | 1.8.0 | 2026-06-30 | Signed AAB 빌드 대기 | Capacitor 알림(채널 생성 포함)·Native Share·뒤로가기 UX·OnGel 폰트·공유 카드 개선. AdMob 인프라 준비, 배너 미노출 |
